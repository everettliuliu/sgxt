...
<body>
    ...
    <main role="main" class="flex-shrink-0">
        ...
        <div class="table-container">
            <div class="title">
                <h3>Editor Main Menu</h3>
            </div>
            <div class="base-card">
             <form method="post" enctype="multipart/form-data"  action="">
                <div class="form-title">
                    <h3>My Assignments with Decision</h3>
                </div>
				   ...
				   <table id="baseTable" class="table table-hover table-bordered table-sm">
						<thead class="detail-table">
                            <tr class="table-tr">
                                ...
                                <th scope="col" style="width:80px;">Editor</br>Decision</th>
                                <th scope="col" style="width:60px;">Author</br>Status</th>
        ...
        {   
           $.each(data,function(i,item){
                ...
                $("#baseTable").append(`<tr>
                                ...
                                <td>${item.EditorDecision}</td>
                                <td>${item.authorDecision}</td>
                                <td>
                                    <div class="dropdown show">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                                            ...
                                            <div style="position: relative;text-indent:1em">
                                                <div >Reject</div>
                                                <input style="position: absolute;opacity: 0;left: 0; top:0" type="submit" value="Reject${item.id}" data-paperid="${item.id}" name="submit_1" class="dropdown-item" onclick="rec();return false;" href="#" ></a>
                                            </div>
                                        </div>
                                    </div>
                                </td>
