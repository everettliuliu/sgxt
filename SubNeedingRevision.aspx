...
<head>
    ...
    <title>Submission Needing Revision</title>
    ...
    <div class="table-container">
        ...
        <div class="base-card">
            ...
            <div class="form-title">
                <h3>Submission Needing Revision</h3>
            </div>
            ...
            <table id="baseTable" class="table table-hover table-bordered table-sm">
                ...
                <tr class="table-tr">
                    ...
                    <th scope="col" style="width:100px">Manuscript Number</th>
                                ...
                                <div class="dropdown show">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                                            ...
                                            <div style="position: relative;text-indent:1em">
                                                ...
                                                <input style="position: absolute;opacity: 0;left: 0; top:0" type="submit" value="View Decision${item.id}" data-paperid="${item.id}" name="submit_1" class="dropdown-item" href="#" ></a>
                                            </div>
                                           
                                              <div style="position: relative;text-indent:1em">
                                                <div >Decline</div>
                                                <input style="position: absolute;opacity: 0;left: 0; top:0" type="submit" value="Remove${item.id}" data-paperid="${item.id}" name="submit_1" class="dropdown-item" onclick="rec();return false;" href="#" ></a>
                                            </div>
                                    </div>
                                </div>
                                </td>
...
<script type="text/javascript">
    ...
    function rec() {
        var mymessage = confirm("确定拒绝修改此稿件？");
        if (mymessage == true) {
            method = "post";
