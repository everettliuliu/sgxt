                                ...
                                <td>
                                    <div class="dropdown show">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                                            ...
                                            <div style="position: relative;text-indent:1em">
                                                <div >Sent Back</div>
                                                <input style="position: absolute;opacity: 0;left: 0; top:0" type="submit" value="Sent Back${item.id}" data-paperid="${item.id}" name="submit_1" class="dropdown-item"  href="#" ></a>
                                            </div>
