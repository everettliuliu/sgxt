            ...
            <div class="content mb-4 mainpage-card">
                <table id="baseTable" class="table table-hover table-bordered table-sm">
                    ...
                    <tr class="table-tr">
                        ...
                        <th scope="col" style="width:70px;">My<br>Reviewer<br>Number</th>
                        ...
                        <th scope="col" style="width:90px;">Date</br>Reviewer<br>Agreed</th>
                                    ...
                                    <div class="dropdown show">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                                            ...
                                            <div style="position: relative;text-indent:1em">
                                                ...
                                                <input style="position: absolute;opacity: 0;left: 0; top:0" type="submit" value="Submit Decision${item.id}" data-paperid="${item.id}" name="submit_1" class="dropdown-item" href="#" ></a>
                                            </div>
