...
<head>
    ...
    <title>Submission with a Decision</title>
...
<main role="main" class="flex-shrink-0">
        <div class="table-container">
            <div class="title">
                <h3>Author Main Menu</h3>
            </div>
            <div class="base-card">
                <div class="form-title">
                    <h3>Submission with a Decision</h3>
                </div>
                ...
                <div class="content mb-4 mainpage-card">
                    <table id="baseTable" class="table table-hover table-bordered table-sm">
                        ...
                        <tr class="table-tr">
                            ...
                            <th scope="col" style="width:100px">Date Final Disposition Set</th>
                            <th scope="col" style="width:100px">Final Disposition</th>
                                ...
                                <div class="dropdown show">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                                        <div style="position: relative">
                                            <div text-indent="2em">View Submission</div>
                                            <input style="position: absolute;opacity: 0;left: 0; top:0" type="submit" value="View Submission${item.id}" data-paperid="${item.id}" name="submit_1" class="dropdown-item" href="#" >
                                        </div>

                                        <div style="position: relative">
                                            <div text-indent="2em">View decision letter</div>
                                            <input style="position: absolute;opacity: 0;left: 0; top:0" type="submit" value="View decision letter${item.id}" data-paperid="${item.id}" name="submit_1" class="dropdown-item" href="#" >
                                        </div>
