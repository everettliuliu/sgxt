...
<head>
    ...
    <title>New Reviewer Invitation</title>
    ...
    <div class="table-container">
        ...
        <div class="base-card">
            ...
            <div class="form-title">
                <h3>New Reviewer Invitations</h3>
            </div>
            <div class="content mb-4 mainpage-card">
                <table id="baseTable" class="table table-hover table-bordered table-sm">
                    ...
                    <tr class="table-tr">
                        ...
                        <th scope="col" style="width:90px;">Corr-Author</th>
                    </tr>
                    </thead>
								...
								<td >
                                    <div class="dropdown show">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                                            ...
                                            <div style="position: relative;text-indent:1em">
                                                <div >Accept</div>
                                                <input style="position: absolute;opacity: 0;left: 0; top:0" type="submit" value="Accept${item.id}" data-paperid="${item.id}" name="submit_1" onclick="recacc();return false;" class="dropdown-item" href="#" ></a>
                                            </div>
                                            <div style="position: relative;text-indent:1em">
                                                <div >Decline</div>
                                                <input style="position: absolute;opacity: 0;left: 0; top:0" type="submit" value="Decline${item.id}" data-paperid="${item.id}" name="submit_1" onclick="recdec();return false;" class="dropdown-item" href="#" ></a>
                                            </div>
                                        </div>
                                    </div>
                                </td>
...
<script type="text/javascript">
    ...
    function recacc() {
        var mymessage = confirm("确定接受审稿邀请？");
        if (mymessage == true) {
            method = "post";
...
<script type="text/javascript">
    ...
    function recdec() {
        var mymessage = confirm("确定拒绝审稿邀请？");
        if (mymessage == true) {
            method = "post";
            action = "modifyParam.action";
            submit();
